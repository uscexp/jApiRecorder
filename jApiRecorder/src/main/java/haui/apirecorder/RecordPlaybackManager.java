...
public class RecordPlaybackManager extends Enhancer implements MethodInterceptor {
	...
	private RecordInformation playback(Object obj, Method method, Object[] args, MethodProxy proxy)
		...
		RecordInformation result = new RecordInformation(method.getName(), args, recordPlaybackConfiguration.getArgumentIndices4PrimaryKey(method.getName()));
	...
	private RecordInformation foreward(Object obj, Method method, Object[] args, MethodProxy proxy) {
		...
		try {
			...
			result = new RecordInformation(method.getName(), args, recordPlaybackConfiguration.getArgumentIndices4PrimaryKey(method.getName()));
